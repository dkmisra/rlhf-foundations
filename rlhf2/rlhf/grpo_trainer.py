...
class GRPOTrainer:
    ...
    Serves as the base for the GRPO-family of RL trainers: rollout generation,
    data preparation, and the SFT-then-RL training loop are shared here, while
    subclasses override :meth:`calc_loss` to change the policy-optimization
    objective.
